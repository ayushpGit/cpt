...
class playground extends Component {
  render() {
    return (
      ...
      //           Better than hotel — Website development
      //         </h1>
      //         {/* role */}
      ...
      //           assets to help designers wireframe their web projects faster.
      //           Over the course of 5 months I designed more than 400 layout
      //           components in 30 categories (each prepared for desktop, tablet &
      //           phone screens), 128 icons, 56 user journey map elements and over
      //           100 user interface elements. You can easily customize and
      //           combine them when working on your wireframes.
      //         </p>
      //         <p className="works-p">
      ...
      //           within the software, as well as to propose improvements
      //           regarding certain functionalities. It was exciting to see how
      //           the product evolved and improved with each update during this
      //           short time.
      //         </p>
      //         <p className="works-p">
